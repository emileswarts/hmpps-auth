...
CREATE USER IF NOT EXISTS NOMIS_NEVER_LOGGED_IN2 password 'password123456';
...
INSERT INTO STAFF_MEMBERS (STAFF_ID, FIRST_NAME, LAST_NAME, STATUS) VALUES (65, 'Never', 'Logged In Email', 'ACTIVE');
...
VALUES ('ITAG_USER', 'GENERAL', 1, 'MDI'),
  ...
  ('PCMS_ANALYST_USER', 'GENERAL', 37, 'BEL'),
  ...
  ('PCMS_AO_USER', 'GENERAL', 45, 'BEL'),
  ('PCMS_GLOBAL_ADMIN_USER', 'GENERAL', 46, 'BEL'),
  ...
  ('PCMS_AUDIT_USER', 'GENERAL', 53, 'BEL'),
  ('HWPV_CLAIM_ENTRY_BAND_2', 'GENERAL', 54, 'BEL'),
  ('HWPV_CLAIM_PAYMENT_BAND_3', 'GENERAL', 55, 'BEL'),
  ('HWPV_CASEWORK_MANAGER_BAND_5', 'GENERAL', 56, 'BEL'),
  ('HWPV_BAND_9', 'GENERAL', 57, 'BEL'),
  ('HWPV_SSCL_USER', 'GENERAL', 58, 'BEL'),
  ('HWPV_ALL_USER', 'GENERAL', 59, 'BEL'),
  ('CA_RO_DM_USER', 'GENERAL', 60, 'BEL'),
  ('PT_OMU_LOCAL', 'GENERAL', 61, 'BEL'),
  ('MMP_USER', 'GENERAL', 62, 'BEL'),
  ('SLM_MAILROOM_USER_LOCAL', 'GENERAL', 63, 'BEL'),
  ('SLM_SECURITY_ANALYST_LOCAL', 'GENERAL', 64, 'BEL'),
  ('NOMIS_NEVER_LOGGED_IN2', 'GENERAL', 65, 'BEL');
...
VALUES ('ITAG_USER', 'OPEN', 'TAG_GENERAL'),
  ...
  ('NOMIS_NEVER_LOGGED_IN2', 'OPEN', 'TAG_GENERAL'),
...
VALUES ('ITAG_USER', '{bcrypt}$2a$10$9rVgms..dZ3gnPSt4JWPA.Oan4MrDHvcx1c.HuYqeMD5rVFmf0C3G'),
  ...
  ('NOMIS_NEVER_LOGGED_IN2', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy'),
...
INSERT INTO USER_ACCESSIBLE_CASELOADS (CASELOAD_ID, USERNAME, START_DATE) VALUES ('NWEB', 'NOMIS_NEVER_LOGGED_IN2', now());
...
VALUES (1, 'OMIC_ADMIN', 'Omic Administrator', 1, 'APP', 'GENERAL'),
  ...
  (34, 'PCMS_ANALYST', 'PCMS Analyst', 99, 'APP', 'ADMIN'),
  ...
  (39, 'PCMS_GLOBAL', 'PCMS Global', 99, 'APP', 'ADMIN'),
  (40, 'PCMS_AUTHORISING_OFFICER', 'PCMS Authorising Officer', 99, 'APP', 'ADMIN'),
  (41, 'PCMS_GLOBAL_ADMIN', 'PCMS Global Admin', 99, 'APP', 'ADMIN'),
  ...
  (45, 'PCMS_AUDIT', 'PCMS Audit', 99, 'APP', 'ADMIN'),
  (46, 'HWPV_CLAIM_ENTRY_BAND_2', 'HWPV Band 2', 99, 'APP', 'ADMIN'),
  (47, 'HWPV_CLAIM_PAYMENT_BAND_3', 'HWPV Band 3', 99, 'APP', 'ADMIN'),
  ...
  (53, 'SLM_SCAN_BARCODE', 'SLM - Mailroom Barcode Scanner', 99, 'APP', 'ADMIN'),
  (54, 'SLM_SECURITY_ANALYST', 'SLM - Security Analyst', 99, 'APP', 'ADMIN');
...
VALUES (-1, 'MDI', 'ITAG_USER'),
  ...
  (34, 'NWEB', 'PCMS_ANALYST_USER'),
  (39, 'NWEB', 'PCMS_ANALYST_USER'),
  (35, 'NWEB', 'PRISON_COLLATOR_LOCAL'),
  (35, 'NWEB', 'PRISON_ANALYST_LOCAL'),
  (36, 'NWEB', 'PF_LOCAL_READER_USER'),
  (37, 'NWEB', 'PF_NATIONAL_READER_USER'),
  (38, 'NWEB', 'PF_HQ_USER'),
  (40, 'NWEB', 'PCMS_AO_USER'),
  (41, 'NWEB', 'PCMS_GLOBAL_ADMIN_USER'),
  (42, 'NWEB', 'ITAG_USER'),
  (44, 'NWEB', 'PPUD_USER'),
  (45, 'NWEB', 'PCMS_AUDIT_USER'),
  (46, 'NWEB', 'HWPV_CLAIM_ENTRY_BAND_2'),
  (46, 'NWEB', 'HWPV_ALL_USER'),
  (47, 'NWEB', 'HWPV_CLAIM_PAYMENT_BAND_3'),
  (47, 'NWEB', 'HWPV_ALL_USER'),
  (48, 'NWEB', 'HWPV_CASEWORK_MANAGER_BAND_5'),
  (48, 'NWEB', 'HWPV_ALL_USER'),
  (49, 'NWEB', 'HWPV_BAND_9'),
  (49, 'NWEB', 'HWPV_ALL_USER'),
  (50, 'NWEB', 'HWPV_SSCL_USER'),
  (50, 'NWEB', 'HWPV_ALL_USER'),
  (11, 'NWEB', 'CA_RO_DM_USER'),
  (12, 'NWEB', 'CA_RO_DM_USER'),
  (13, 'NWEB', 'CA_RO_DM_USER'),
  (8, 'NWEB', 'CA_RO_DM_USER'),
  (51, 'NWEB', 'MMP_USER'),
  (52, 'NWEB', 'CALCULATE_RELEASE_DATES_LOCAL'),
  (53, 'NWEB', 'SLM_MAILROOM_USER_LOCAL'),
  (54, 'NWEB', 'SLM_SECURITY_ANALYST_LOCAL');
