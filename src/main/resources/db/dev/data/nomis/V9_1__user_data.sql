...
CREATE USER IF NOT EXISTS PPM_AUDIT_USER password 'password123456';
...
INSERT INTO STAFF_MEMBERS (STAFF_ID, FIRST_NAME, LAST_NAME, STATUS) VALUES (53, 'PPM', 'Audit', 'ACTIVE');
...
VALUES ('ITAG_USER', 'OPEN', 'TAG_GENERAL'),
  ...
  ('PPM_AUDIT_USER', 'OPEN', 'TAG_GENERAL'),
...
VALUES ('ITAG_USER', '{bcrypt}$2a$10$9rVgms..dZ3gnPSt4JWPA.Oan4MrDHvcx1c.HuYqeMD5rVFmf0C3G'),
  ...
  ('PPM_AUDIT_USER', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy'),
...
INSERT INTO USER_ACCESSIBLE_CASELOADS (CASELOAD_ID, USERNAME, START_DATE) VALUES ('NWEB', 'PPM_AUDIT_USER', now());
...
VALUES (1, 'OMIC_ADMIN', 'Omic Administrator', 1, 'APP', 'GENERAL'),
  ...
  (45, 'PPM_AUDIT', 'PPM Audit', 99, 'APP', 'ADMIN'),
