...
VALUES ('A04C70EE-51C9-4852-8D0D-130DA5C85C42', 'ITAG_USER', 'itag_user@digital.justice.gov.uk', true, 'nomis'),
       ('A04C70EE-51C9-4852-8D0D-130DA5C85C43', 'RESET_USER', 'reset_user@digital.justice.gov.uk', true, 'nomis'),
       ('0181F647-C7D4-41E7-9271-288EC7C01F90', 'DM_USER', 'dm_user@digital.justice.gov.uk', false, 'nomis'),
       ('151DD6BC-88EE-4246-AA18-45924819C9F5', 'EXPIRED_TEST_USER', 'expired_test_user@digital.justice.gov.uk', true, 'nomis'),
       ...
       ('846D7318-921C-4537-8E24-58306CED881B', 'PPL_USER', 'ppl_user@digital.justice.gov.uk', true, 'nomis'),
       ('326A07B4-6C2F-4CF9-A904-84262EB5C4FF', 'DM_USER_TEST', 'dm_user_test@digital.justice.gov.uk', true, 'nomis'),
       ('7969D655-03F6-464E-A318-9D3C8B53787A', 'EXPIRED_TEST2_USER', 'expired_test2_user@digital.justice.gov.uk', true, 'nomis'),
       ('FCFC15C1-6EE5-4EB2-8312-A1302AE3CFD1', 'ITAG_USER_ADM', 'itag_user_adm@digital.justice.gov.uk', true, 'nomis'),
       ('E94B2E26-DC8A-4020-9533-A509807F68DF', 'EXPIRED_TEST3_USER', 'expired_test3_user@digital.justice.gov.uk', true, 'nomis'),
       ('C0279EE3-76BF-487F-833C-AA47C5DF22F8', 'CA_USER', 'ca_user@digital.justice.gov.uk', true, 'nomis'),
       ('6A3F0216-BBAB-49CD-BD6E-AC09C1762EE4', 'LOCKED_USER', 'locked@somewhere.com', true, 'nomis'),
       ('6A3F0216-BBAB-49CD-BD6E-AC09C1762EE5', 'LOCKED_NOMIS_USER', 'lockednomisuser@somewhere.com', true, 'nomis'),
       ('79CDC23C-510F-4CE2-8C98-AC251296EC39', 'RO_DEMO', 'ro_user@some.justice.gov.uk', false, 'nomis'),
       ('AB8DA2CA-3E79-42D3-883E-CEE6C3F693CA', 'RO_USER_TEST', 'ro_user_test@digital.justice.gov.uk', true, 'nomis'),
       ...
       ('AAABF8D7-4164-47B3-826F-ECD3BB64300F', 'PF_RO_USER', 'pf_ro_user@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-493B-9424-DBCC65E7BFED', 'UOF_COORDINATOR_USER', 'uof_coordinator@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-493B-9424-DBCC65E7BFEE', 'LICENCE_READONLY_TEST', 'licence_readonly_test@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-493B-9424-DBCC65E8BFEF', 'RO_USER_READONLY_TEST', 'ro_user_readonly_test@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-493B-9424-DBCC65E8BFED', 'CA_RO_DM_USER', 'ca_ro_dm_user_test@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-667B-8711-DA7EB4432CED', 'SOC_PRISON_LOCAL', 'soc_prison_local@digital.justice.gov.uk', true, 'nomis'),
       ('4115C3DF-317B-4007-BF58-F2ECA1BBEED4', 'PCMS_ANALYST_USER', 'pcms_analyst_user@digital.justice.gov.uk', true, 'nomis'),
       ('68599FE3-522D-4210-8296-D1469C35B93E', 'PCMS_AO_USER', 'pcms_ao_user@digital.justice.gov.uk', true, 'nomis'),
       ('26E3087B-FA89-4D8B-914C-D72B287E4289', 'PCMS_GLOBAL_ADMIN_USER', 'pcms_global_admin_user@digital.justice.gov.uk', true, 'nomis'),
       ...
       ('C3B15C4B-ADF5-493B-9424-DBCC65E7BAAA', 'CALCULATE_RELEASE_DATES_LOCAL', 'calculate_release_dates_local@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-493B-9424-DBCC65B3CAAB', 'CVL_OMU_LOCAL', 'cvl_omu_local@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-493B-9424-DBCC65B3CAAC', 'PCMS_AUDIT_USER', 'pcms_audit_user@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-493B-9424-DBCC65B3CAAD', 'HWPV_CLAIM_ENTRY_BAND_2', 'prisonvisitsbooking@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-493B-9424-DBCC65B3CAAE', 'HWPV_CLAIM_PAYMENT_BAND_3', 'prisonvisitsbooking@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-493B-9424-DBCC65B3CAAF', 'HWPV_CASEWORK_MANAGER_BAND_5', 'prisonvisitsbooking@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-493B-9424-DBCC65B3CABA', 'HWPV_BAND_9', 'prisonvisitsbooking@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-493B-9424-DBCC65B3CABB', 'HWPV_SSCL_USER', 'prisonvisitsbooking@digital.justice.gov.uk', true, 'nomis'),
       ('C3B15C4B-ADF5-493B-9424-DBCC65B3CABC', 'HWPV_ALL_USER', 'prisonvisitsbooking@digital.justice.gov.uk', true, 'nomis'),
...
VALUES ('608955AE-52ED-44CC-884C-011597A77949', 'AUTH_USER', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_user@digital.justice.gov.uk', 'Auth', 'Only', true, true, false, 'auth'),
       ...
       ('D9291E62-FCDF-42E4-B31E-2E93AD5BC46A', 'AUTH_NO_ROLES_USER', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'authnoroles@digital.justice.gov.uk', 'NoRoles', 'User', true, true, false, 'auth'),
       ('90F930E1-2195-4AFD-92CE-0EB5672DA02A', 'AUTH_RO_USER_TEST', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_ro_user_test@digital.justice.gov.uk', 'Ryan-Auth', 'Orton', true, true, false, 'auth'),
       ('90F930E1-2195-4AFD-92CE-0EB5672DA02B', 'AUTH_RO_USER_TEST2', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_ro_user_test2@digital.justice.gov.uk', 'Ryan-Auth', 'Orton2', true, true, false, 'auth'),
       ('90F930E1-2195-4AFD-92CE-0EB5672DA02C', 'AUTH_RO_USER_TEST3', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_ro_user_test3@digital.justice.gov.uk', 'Ryan-Auth', 'Orton3', true, true, false, 'auth'),
       ...
       ('5E3850B9-9D6E-49D7-B8E7-42874D6CEEA8', 'AUTH_RO_VARY_USER', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_ro_user@digital.justice.gov.uk', 'Ryan-Auth-Vary', 'Orton', true, true, false, 'auth'),
       ('AD7D37E2-DBAD-4B98-AF8D-429E822A6BDC', 'AUTH_DISABLED', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_disabled@digital.justice.gov.uk', 'Auth', 'Disabled', true, false, false, 'auth'),
       ('7CA04ED7-8275-45B2-AFB4-4FF51432D1EA', 'AUTH_RO_USER', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_ro_user@digital.justice.gov.uk', 'Ryan-Auth', 'Orton', true, true, false, 'auth'),
       ('7CA04ED7-8275-45B2-AFB4-4FF51432D1EB', 'AUTH_RO_USER1@DIGITAL.JUSTICE.GOV.UK', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_ro_user1@digital.justice.gov.uk', 'Ryan-Auth', 'Orton', true, true, false, 'auth'),
       ('7CA04ED7-8275-45B2-AFB4-4FF51432D1EC', 'AUTH_RO_USER2', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_ro_user2@digital.justice.gov.uk', 'Ryan-Auth', 'Orton', true, true, false, 'auth'),
       ('1F650F15-0993-4DB7-9A32-5B930FF86035', 'AUTH_GROUP_MANAGER', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_group_manager@digital.justice.gov.uk', 'Group', 'Manager', true, true, false, 'auth'),
       ('1F650F15-0993-4DB7-9A32-5B930FF86036', 'AUTH_GROUP_MANAGER2', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_group_manager2@digital.justice.gov.uk', 'Group', 'Manager2', true, true, false, 'auth'),
       ('1F650F15-0993-4DB7-9A32-5B930FF86037', 'AUTH_DEVELOPER', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_developer@digital.justice.gov.uk', 'Auth', 'Developer', true, true, false, 'auth'),
       ('FC494152-F9AD-48A0-A87C-9ADC8BD75255', 'AUTH_STATUS', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', null, 'Auth', 'Status', true, false, false, 'auth'),
       ('FC494152-F9AD-48A0-A87C-9ADC8BD75266', 'AUTH_STATUS2', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', null, 'Auth', 'Status2', true, false, false, 'auth'),
       ('FC494152-F9AD-48A0-A87C-9ADC8BD75277', 'AUTH_STATUS3', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', null, 'Auth', 'Status3', true, false, false, 'auth'),
       ('FC494152-F9AD-48A0-A87C-9ADC8BD75288', 'AUTH_STATUS4', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', null, 'Auth', 'Status4', true, false, false, 'auth'),
       ('FC494152-F9AD-48A0-A87C-9ADC8BD75299', 'AUTH_STATUS5', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', null, 'Auth', 'Status5', true, false, false, 'auth'),
       ('9E84F1E4-59C8-4B10-927A-9CF9E9A30791', 'AUTH_EXPIRED', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '2013-01-28 13:23:19.0000000', 'auth_test2@digital.justice.gov.uk', 'Auth', 'Expired', true, true, false, 'auth'),
       ('9E84F1E4-59C8-4B10-927A-9CF9E9A30792', 'AUTH_MFA_EXPIRED', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '2013-01-28 13:23:19.0000000', 'auth_test3@digital.justice.gov.uk', 'Auth', 'Expired', true, true, false, 'auth'),
       ('5105A589-75B3-4CA0-9433-B96228C1C8F3', 'AUTH_ADM', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_test2@digital.justice.gov.uk', 'Auth', 'Adm', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2A3E', 'AUTH_TEST', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_test@digital.justice.gov.uk', 'Auth', 'Test', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2B3F', 'AUTH_CHANGE_TEST', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_test@digital.justice.gov.uk', 'Auth', 'Test', true, true, false, 'auth'),
       ...
       ('2E285CCD-DCFD-4497-9E26-D6E8E10A2D3F', 'AUTH_USER_EMAIL2_TEST@JUSTICE.GOV.UK', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_user_email2_test@justice.gov.uk', 'User', 'Email Test', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E27-D6E8E10A2D3F', 'AUTH_USER_EMAIL3_TEST@JUSTICE.GOV.UK', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_user_email3_test@justice.gov.uk', 'User', 'Email Test', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E28-D6E8E10A2D3F', 'AUTH_BULK_AMEND_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_change@justice.gov.uk', 'User', 'Change Test', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E29-D6E8E10A2D3F', 'AUTH_BULK_AMEND_EMAIL@DIGITAL.JUSTICE.GOV.UK', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_bulk_amend_email@digital.justice.gov.uk', 'User', 'Change Test', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E30-D6E8E10A2D3F', 'AUTH_CHANGE_TO_USERNAME', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_change@justice.gov.uk', 'User', 'Change Test', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D4F', 'AUTH_CHANGE_EMAIL2', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_email@digital.justice.gov.uk', 'Auth', 'Test', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D5F', 'AUTH_CHANGE_EMAIL_VERIFIED', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_email@digital.justice.gov.uk', 'Auth', 'Email', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D6F', 'AUTH_CHANGE_EMAIL_GSI', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_email@digital.justice.gov.uk', 'Auth', 'Email', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D7F', 'AUTH_CHANGE_EMAIL_INVALID', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_email@digital.justice.gov.uk', 'Auth', 'Email', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D8F', 'AUTH_CHANGE_EMAIL_INCOMPLETE', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_email@digital.justice.gov.uk', 'Auth', 'Email', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D40', 'AUTH_CHANGE_MOBILE', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_mobile@digital.justice.gov.uk', 'Auth', 'Mobile', true, true, false, 'auth'),
       ...
       ('2E285CCE-DCFD-4497-9E22-D6E8E10A2A3F', 'AUTH_MFA_TOKEN_USER', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'mfa_user@digital.justice.gov.uk', 'Mfa', 'User', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2A4F', 'AUTH_MFA_EXPIRED_USER', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'mfa_user@digital.justice.gov.uk', 'Mfa', 'User', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2A5F', 'AUTH_MFA_LOCKED_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'mfa_user@digital.justice.gov.uk', 'Mfa Locked', 'User', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2A6F', 'AUTH_MFA_LOCKED2_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'mfa_user@digital.justice.gov.uk', 'Mfa Locked', 'User', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E21-D6E8E10A2A9F', 'AUTH_MFA_LOCKED3_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'mfa_user@digital.justice.gov.uk', 'Mfa Locked', 'User', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E21-D6E8E10A2A10', 'AUTH_MFA_LOCKED4_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'mfa_user@digital.justice.gov.uk', 'Mfa Locked', 'User', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E21-D6E8E10A2A11', 'AUTH_MFA_LOCKED5_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'mfa_user@digital.justice.gov.uk', 'Mfa Locked', 'User', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E21-D6E8E10A2A12', 'AUTH_MFA_LOCKED6_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'mfa_user@digital.justice.gov.uk', 'Mfa Locked', 'User', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-E6E8E10A2A6F', 'AUTH_MFA_CHANGE', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'mfa_user@digital.justice.gov.uk', 'Mfa Locked', 'User', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-F6E8E10A2A6F', 'AUTH_MFA_CHANGE_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_email@digital.justice.gov.uk', 'Mfa', 'User', true, true, false, 'auth'),
       ('C6C9C675-32C0-4f58-936B-07744f0E4317', 'AUTH_REGISTERS_USER', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'registers_maintainer@digital.justice.gov.uk', 'Registers', 'Maintainer', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-A9E8E10A2A60', 'AUTH_SECOND_EMAIL_ADD', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_email@digital.justice.gov.uk', 'email', 'User', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-A9E8E10A2A61', 'AUTH_SECOND_EMAIL_UPDATE', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_email@digital.justice.gov.uk', 'email', 'User', true, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-A9E8E10A2A62', 'AUTH_SECOND_EMAIL_VERIFY', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_email@digital.justice.gov.uk', 'email', 'User', true, true, false, 'auth'),
       ...
       ('2E285CCD-DCFD-4497-9E22-A9E8E10A2A69', 'AUTH_CREATE_USER_VALID2', null, '2020-01-28 13:23:19.0000000', 'create_user@digital.justice.gov.uk', 'email', 'User', false, true, false, 'auth'),
       ('2E285CCD-DCFD-4497-9E22-A9E8E10A2A6A', 'AUTH_CREATE_USER_EXPIRED', null, '2020-01-28 13:23:19.0000000', 'auth_email@digital.justice.gov.uk', 'email', 'User', false, true, false, 'auth'),
       ...
       ('f83c7a90-50c2-4b1b-b5ab-59206f731203', 'DELIUS_ENABLED_AUTH_DISABLED_LOCKED', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'delius_auth_user@digital.justice.gov.uk', 'delius enabled', 'Auth Disabled Locked', true, false, true, 'auth'),
...
VALUES ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D60', 'AUTH_MFA_PREF_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.email@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'EMAIL'),
       ...
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D63', 'AUTH_MFA_PREF_EMAIL4', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.email@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D64', 'AUTH_MFA_PREF_TEXT', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.text@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'TEXT'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D65', 'AUTH_MFA_PREF_TEXT2', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.text@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'TEXT'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D66', 'AUTH_MFA_PREF_TEXT3', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.text@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'TEXT'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D67', 'AUTH_MFA_PREF_TEXT4', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.text@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'TEXT'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2A11', 'AUTH_MFA_PREF_TEXT5', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.text@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'TEXT'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D68', 'AUTH_MFA_LOCKED_TEXT', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.text@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'TEXT'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D69', 'AUTH_MFA_LOCKED2_TEXT', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.text@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'TEXT'),
       ('2E285CCD-DCFD-4497-9E23-D6E8E10A2D69', 'AUTH_MFA_LOCKED3_TEXT', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.text@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'TEXT'),
       ('2E285CCD-DCFD-4497-9E23-D6E8E10A2D01', 'AUTH_MFA_LOCKED4_TEXT', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.text@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'TEXT'),
       ('2E285CCD-DCFD-4497-9E23-D6E8E10A2D02', 'AUTH_MFA_LOCKED5_TEXT', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.text@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'TEXT'),
       ('2E285CCF-DCFD-4498-9E22-D6E8E10A2D6A', 'AUTH_MFA_NOTEXT_USER', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.text@digital.justice.gov.uk', 'Mfa No Text', 'User', false, true, false, 'auth','TEXT'),
       ('2E285CCF-DCFD-4499-9E22-D6E8E10A2D6B', 'AUTH_MFA_PREF_TEXT_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.text@digital.justice.gov.uk', 'Mfa No Text', 'User', true, true, false, 'auth', 'TEXT'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D6C', 'AUTH_MFA_SHORT_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'bob@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D6D', 'AUTH_MFA_NON_VERIFIED', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'bob@digital.justice.gov.uk', 'Auth', 'Mfa', false, true, false, 'auth', 'EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D6E', 'AUTH_MFA_PREF_EMAIL5', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.email@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'EMAIL'),
       ('2E285CCD-DCFD-4497-9E21-D6E8E10A2D6F', 'AUTH_MFA_PREF_EMAIL6', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.email@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D70', 'AUTH_UNVERIFIED_TEXT', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_unverified@digital.justice.gov.uk', 'Auth', 'Mfa', false, true, false, 'auth', 'TEXT'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D71', 'AUTH_MFA_PREF_2ND_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_unverified@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'SECONDARY_EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D72', 'AUTH_MFA_PREF_2ND_EMAIL2', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_unverified@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'SECONDARY_EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D73', 'AUTH_MFA_PREF_2ND_EMAIL3', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_unverified@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'SECONDARY_EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D74', 'AUTH_MFA_PREF_2ND_EMAIL4', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_unverified@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'SECONDARY_EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D75', 'AUTH_MFA_LOCKED_2ND_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_unverified@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'SECONDARY_EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D76', 'AUTH_MFA_LOCKED2_2ND_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_unverified@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'SECONDARY_EMAIL'),
       ('2E285CCD-DCFD-4497-9E21-D6E8E10A2D76', 'AUTH_MFA_LOCKED3_2ND_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_unverified@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'SECONDARY_EMAIL'),
       ('2E285CCD-DCFD-4497-9E20-D6E8E10A2D76', 'AUTH_MFA_LOCKED4_2ND_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_unverified@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'SECONDARY_EMAIL'),
       ('2E285CCD-DCFD-4497-9E19-D6E8E10A2D76', 'AUTH_MFA_LOCKED5_2ND_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_unverified@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'SECONDARY_EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D77', 'AUTH_MFA_PREF_2ND_EMAIL_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth_unverified@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'SECONDARY_EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D80', 'AUTH_PREF_TEXT', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.pref.text@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'TEXT'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D81', 'AUTH_PREF_2ND_EMAIL', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.pref.secondemail@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'SECONDARY_EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D83', 'AUTH_PREF_EMAIL_TEXT', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.pref.secondemail@digital.justice.gov.uk', 'Auth', 'Mfa', true, true, false, 'auth', 'SECONDARY_EMAIL'),
       ('2E285CCD-DCFD-4497-9E22-D6E8E10A2D82', 'AUTH_NO_PREF', '{bcrypt}$2a$10$Fmcp2KUKRW53US3EJfsxkOh.ekZhqz5.Baheb9E98QLwEFLb9csxy', '3013-01-28 13:23:19.0000000', 'auth.no.pref@digital.justice.gov.uk', 'Auth', 'Mfa', false, true, false, 'auth', 'TEXT'),
...
INSERT INTO user_role (role_id, user_id) SELECT role_id, user_id from roles, users where username = 'AUTH_REGISTERS_USER' and role_code = 'HMPPS_REGISTERS_MAINTAINER';
...
INSERT INTO user_contact (user_id, type, details) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com' FROM users where username = 'AUTH_ADM';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_PREF_EMAIL';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_PREF_EMAIL5';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_SECOND_EMAIL_UPDATE';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'bob@gmail.com', false FROM users where username = 'AUTH_SECOND_EMAIL_VERIFY';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'bob@gmail.com', false FROM users where username = 'AUTH_SECOND_EMAIL_VERIFY2';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_SECOND_EMAIL_ALREADY';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_SECOND_EMAIL_CHANGE';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_PREF_TEXT5';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_PREF_2ND_EMAIL';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_PREF_2ND_EMAIL2';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_PREF_2ND_EMAIL3';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_PREF_2ND_EMAIL4';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_LOCKED_2ND_EMAIL';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_LOCKED2_2ND_EMAIL';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_LOCKED3_2ND_EMAIL';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_LOCKED4_2ND_EMAIL';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_LOCKED5_2ND_EMAIL';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_MFA_PREF_EMAIL_AND_TEXT';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', false FROM users where username = 'AUTH_USER_2ND_EMAIL_LINK_EXP';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_CHANGE_MOBILE_VERIFIED';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', false FROM users where username = 'AUTH_CHANGE_MOBILE_UPDATE';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', false FROM users where username = 'AUTH_UNVERIFIED';

INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_PREF_EMAIL';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_PREF_EMAIL2';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_PREF_EMAIL3';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_PREF_EMAIL4';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_PREF_TEXT';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_PREF_TEXT2';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_PREF_TEXT3';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_PREF_TEXT4';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_PREF_TEXT5';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_LOCKED_TEXT';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_LOCKED2_TEXT';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_LOCKED3_TEXT';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_LOCKED4_TEXT';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_LOCKED5_TEXT';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', false FROM users where username = 'AUTH_MFA_SHORT_EMAIL';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', false FROM users where username = 'AUTH_MFA_UNVERIFIED';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_PREF_EMAIL5';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', false FROM users where username = 'AUTH_UNVERIFIED_TEXT';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_PREF_2ND_EMAIL2';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_MFA_PREF_EMAIL_AND_TEXT';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_PREF_TEXT';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'MOBILE_PHONE', '07700900321', true FROM users where username = 'AUTH_PREF_EMAIL_TEXT';
INSERT INTO user_contact (user_id, type, details, verified) SELECT user_id, 'SECONDARY_EMAIL', 'john@smith.com', true FROM users where username = 'AUTH_PREF_2ND_EMAIL';
