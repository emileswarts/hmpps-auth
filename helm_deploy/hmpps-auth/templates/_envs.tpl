...
env:
  ...
  - name: APPLICATION_LINK_ACCOUNTS
    value: {{ .Values.env.APPLICATION_LINK_ACCOUNTS | quote }}
  ...
  - name: DELIUS_ROLES_MAPPINGS_CVLBT001
    value: "ROLE_LICENCE_ACO"
  ...
  - name: DELIUS_ROLES_MAPPINGS_MAABT001
    value: "ROLE_MANAGE_A_WORKFORCE_ALLOCATE"

  - name: DELIUS_ROLES_MAPPINGS_MASBT001
    value: "ROLE_MANAGE_SUPERVISIONS_RO"
